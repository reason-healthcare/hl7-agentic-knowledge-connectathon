...
- The USPSTF recommendation snapshot is reproduced unchanged under the
  reproduction terms stated on the source page.
- The AHRQ evidence update identifies the publication as public domain.
...
content remain link-only and are not copied into this repository.
