# TNBC, clinical T2 N0 M0

Synthetic FHIR R4 educational test case; no real patient information.

The node-negative tumor has explicit clinical T2 staging. The ASCO TNBC review criterion is met. This exercises the higher-than-T1c route, not just equality with T1c.

- Active, confirmed invasive breast cancer Condition: present.
- Clinical assessment: cT2, cN0, cM0.
- Longest tumor dimension: 25 mm.
