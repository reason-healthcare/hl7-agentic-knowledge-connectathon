# TNBC, T1c N0 M0, size in centimeters

Synthetic FHIR R4 educational test case; no real patient information.

The 1.5 cm quantity is equivalent to the 15 mm baseline; the supplied clinical T1c assessment controls the stage criterion in both cases.

- Active, confirmed invasive breast cancer Condition: present.
- Clinical assessment: cT1c, cN0, cM0.
- Longest tumor dimension: 1.5 cm.
