# TNBC without distant-metastasis assessment

Synthetic FHIR R4 educational test case; no real patient information.

Absence of a metastasis assessment is not evidence of cM0; population membership and applicability remain unknown.

- Active, confirmed invasive breast cancer Condition: present.
- Clinical assessment: cT1c, cN0, M unknown.
...
| `In Neoadjuvant Review Population` | unknown (null) |
