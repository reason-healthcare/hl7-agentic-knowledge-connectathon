# HER2 interpretation unresolved

Synthetic FHIR R4 educational test case; no real patient information.

The supplied HER2 interpretation is equivocal, without a resolving result. It is neither positive nor negative and cannot establish TNBC.

- Active, confirmed invasive breast cancer Condition: present.
- Clinical assessment: cT1c, cN0, cM0.
- Longest tumor dimension: 15 mm.
- ER: negative; PR: negative; HER2: equivocal.
